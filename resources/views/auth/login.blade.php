        ...
        <div class="content-wrapper">
            ...
            <div class="content d-flex justify-content-center align-items-center">
                ...
                <form class="login-form " method="post" action="{{ route('login') }}">
                    @csrf
                    <div class="card mb-0 bg-dark-alpha">
                        <div class="card-body">
                            <div class="text-center mb-3">
                                <i class="icon-key text-black-50 icon-2x text-warning-400 border-warning-400 border-3 rounded-round p-3 mb-3 mt-1 border-blue"></i>
                                <h5 class="mb-0">Login</h5>
                                <span class="d-block text-muted text-black-50">Enter Email and Password</span>
                            </div>
...
{{--                            </div>--}}
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-block btn-secondary ">Login</i></button>
                            </div>
