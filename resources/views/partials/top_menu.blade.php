  ...
  {{--  <div class="navbar-brand">
    ...
    <div class="mt-2 mr-5">
        <a href="{{ route('dashboard') }}" class="d-inline-block">
            <h4 class="text-bold text-black-50">{{ Qs::getSystemName() }}</h4>
        </a>
    </div>

{{--    <div class="d-md-none">--}}
{{--        <button class="navbar-toggler text-black-50" type="button" data-toggle="collapse" data-target="#navbar-mobile">--}}
{{--            <i class="icon-tree5 text-black-50"></i>--}}
{{--        </button>--}}
{{--        <button class="navbar-toggler sidebar-mobile-main-toggle" type="button">--}}
{{--            <i class="icon-paragraph-justify3 text-black-50"></i>--}}
{{--        </button>--}}
{{--    </div>--}}
